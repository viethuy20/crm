...
namespace PQT.Web.Controllers
{
    public class NewEventController : Controller
    {
        ...
        public ActionResult AjaxGetNewEvents()
        {
            ...
            {
                leads = _repo.GetAllLeadNews(m => 
                                               (saleId == 0 || (m.AssignUserID == null && m.UserID == saleId) ||
                                                (m.AssignUserID == null && m.User != null && m.User.TransferUserID == saleId)||
                                                (m.AssignUserID != null && m.AssignUserID == saleId) ||
                                                (m.AssignUser != null && m.AssignUser.TransferUserID == saleId)) && (
            ...
            {
                leads = _repo.GetAllLeadNews(m => (saleId == 0 || (m.AssignUserID == null && m.UserID == saleId) ||
                                                   (m.AssignUserID == null && m.User != null && m.User.TransferUserID == saleId) ||
                                                   (m.AssignUserID != null && m.AssignUserID == saleId) ||
                                                   (m.AssignUser != null && m.AssignUser.TransferUserID == saleId)));
            }
