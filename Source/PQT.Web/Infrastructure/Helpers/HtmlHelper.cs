...
namespace PQT.Web.Infrastructure.Helpers
{
    public static class BootstrapHtmlHelper
    {
        ...
        public static MvcHtmlString DatePickerRangeFor<TModel, TValue>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TValue>> expression, object htmlAttributes)
        {
            return htmlHelper.DatePickerRangeFor(expression, null, htmlAttributes);
        }
        public static MvcHtmlString DatePickerRangeFor<TModel, TValue>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TValue>> expression, string format, object htmlAttributes)
        {
