        ...
        BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/content/css/min").Include(
                ...
                , "~/Content/js/libs/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css"
                ...
                , "~/Content/css/theme-default/libs/DataTables/database.css"
                , "~/Content/css/theme-default/libs/DataTables/fixedHeader.dataTables.min.css"
            ...
            bundles.Add(new JsBundle("~/content/js/min").Include(
                ...
                , "~/Content/js/libs/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"
