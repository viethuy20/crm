...
namespace PQT.Domain.Enum
{
    ...
    {
        public static readonly PaymentStatus Initial = New<PaymentStatus>("", "Live");
    ...
    {
        public static readonly AttendanceStatus Initial = New<AttendanceStatus>("", "Live");
    ...
    {
        public static readonly DelegateAttendanceStatus Initial = New<DelegateAttendanceStatus>("", "Live");
